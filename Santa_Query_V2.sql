...
(
    ...
    FOREIGN KEY (boardId) REFERENCES Administrators (admin_id) ON DELETE CASCADE
);
...
VALUES ('굿헬스 공급사', '010-2222-3333', '서울'),
...
VALUES ('비타민C', '고용량 비타민C 1000mg', 1, 25000, 1),
...
-- 10. Orders 테이블
INSERT INTO Orders (warehouse_id, branch_id, status)
VALUES (1, 1, '대기'),
       (2, 2, '완료'),
       (3, 3, '취소');
...
-- 12. Incoming 테이블
INSERT INTO Incoming (warehouse_id, product_id, supplier_id, quantity)
VALUES (1, 1, 1, 200),
       (2, 3, 3, 300),
       (4, 5, 5, 100);
...
-- 15. Transit 테이블
INSERT INTO Transit (outgoing_id, warehouse_id, branch_id, product_id, quantity, status)
VALUES (1, 3, 1, 2, 80, '배송중'),
       (2, 4, 2, 3, 90, '배송대기'),
       (3, 1, 3, 4, 40, '배송취소')
;